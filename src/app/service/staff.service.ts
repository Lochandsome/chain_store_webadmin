...
export class StaffService {
  ...
  getStaffwithaccountid(id: string) {
    return this.httpClient.get(this.createCompleteRoute("staff/withaccountid/" + id, environment.urlAddress), { headers: this.headers });
  }
  // get staff by store
  ...
  getAllStaff(): Observable<any> {
    return this.httpClient.get(this.createCompleteRoute(`${this.urlPartner}/${"AllStaff"}`, environment.urlAddress),
      { headers: this.headers }).pipe(catchError(this.handleError));
  }
