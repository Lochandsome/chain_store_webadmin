...
export class EditOrderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // console.log(new Date().toISOString().substring(0,1));
  }
  ...
  updateBill(): void {
    ...
    const data = {
      ...
      customerName: this.currentOrderDetail.customerName,
      customerEmail: this.currentOrderDetail.customerEmail,
      customerPhone: this.currentOrderDetail.customerPhone.toString(),
      customerMessage: this.currentOrderDetail.customerMessage,
      customerAddress: this.currentOrderDetail.customerAddress,
